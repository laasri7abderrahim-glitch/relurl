...
const categoryMap: CategoryMap = {
  ...
  platform: ["shorten-github-url", "shorten-google-drive-link", "shorten-google-docs-link", "shorten-dropbox-link", "shorten-spotify-link", "shorten-amazon-link", "shorten-shopify-link", "shorten-medium-link", "shorten-notion-link", "shorten-figma-link", "shorten-calendly-link", "shorten-patreon-link", "shorten-etsy-link", "shorten-airbnb-link", "shorten-substack-link"],
  ...
  comparison: ["bitly-alternative", "tinyurl-alternative", "rebrandly-alternative", "short-io-alternative", "best-url-shortener", "relurl-vs-tinyurl", "relurl-vs-bitly"],
  guide: ["how-to-shorten-a-url", "how-to-create-short-links", "how-to-track-link-clicks", "how-to-create-qr-codes", "how-to-create-branded-links", "how-to-use-utm-parameters", "how-to-create-qr-codes-for-business", "how-to-make-money-with-url-shortener"],
  noSignup: ["url-shortener-no-signup", "url-shortener-without-signup"],
  business: ["url-shortener-for-business", "url-shortener-for-marketers", "url-shortener-for-social-media"],
  local: ["url-shortener-in-india", "url-shortener-in-uk", "url-shortener-in-canada"],
  feature: ["url-shortener-with-qr-codes", "url-shortener-with-analytics", "url-shortener-no-ads"],
}
...
export const allPages: PageEntry[] = [
  ...
  { title: "Shorten Spotify Link", href: "/shorten-spotify-link", category: "platform" },
  { title: "Shorten Amazon Link", href: "/shorten-amazon-link", category: "platform" },
  { title: "Shorten Shopify Link", href: "/shorten-shopify-link", category: "platform" },
  { title: "Shorten Medium Link", href: "/shorten-medium-link", category: "platform" },
  { title: "Shorten Notion Link", href: "/shorten-notion-link", category: "platform" },
  { title: "Shorten Figma Link", href: "/shorten-figma-link", category: "platform" },
  { title: "Shorten Calendly Link", href: "/shorten-calendly-link", category: "platform" },
  { title: "Shorten Patreon Link", href: "/shorten-patreon-link", category: "platform" },
  { title: "Shorten Etsy Link", href: "/shorten-etsy-link", category: "platform" },
  { title: "Shorten Airbnb Link", href: "/shorten-airbnb-link", category: "platform" },
  { title: "Shorten Substack Link", href: "/shorten-substack-link", category: "platform" },
  ...
  { title: "RELURL vs TinyURL", href: "/relurl-vs-tinyurl", category: "comparison" },
  { title: "RELURL vs Bitly", href: "/relurl-vs-bitly", category: "comparison" },
  ...
  { title: "How to Create QR Codes for Business", href: "/how-to-create-qr-codes-for-business", category: "guide" },
  { title: "How to Make Money with URL Shortener", href: "/how-to-make-money-with-url-shortener", category: "guide" },
  { title: "URL Shortener No Signup", href: "/url-shortener-no-signup", category: "noSignup" },
  { title: "URL Shortener Without Signup", href: "/url-shortener-without-signup", category: "noSignup" },
  { title: "URL Shortener for Business", href: "/url-shortener-for-business", category: "business" },
  { title: "URL Shortener for Marketers", href: "/url-shortener-for-marketers", category: "business" },
  { title: "URL Shortener for Social Media", href: "/url-shortener-for-social-media", category: "business" },
  { title: "URL Shortener in India", href: "/url-shortener-in-india", category: "local" },
  { title: "URL Shortener in UK", href: "/url-shortener-in-uk", category: "local" },
  { title: "URL Shortener in Canada", href: "/url-shortener-in-canada", category: "local" },
  { title: "URL Shortener with QR Codes", href: "/url-shortener-with-qr-codes", category: "feature" },
  { title: "URL Shortener with Analytics", href: "/url-shortener-with-analytics", category: "feature" },
  { title: "URL Shortener No Ads", href: "/url-shortener-no-ads", category: "feature" },
]

export const socialPages: PageEntry[] = [
  { title: "Signal Link Generator", href: "/signal-link-generator", category: "social-tool" },
  { title: "WeChat Link Generator", href: "/wechat-link-generator", category: "social-tool" },
  { title: "Slack Link Generator", href: "/slack-link-generator", category: "social-tool" },
